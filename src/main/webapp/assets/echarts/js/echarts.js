function echartRun(src,date) {
    ...
    function echarts_1() {
        ...
        $.ajax({
            ...
            url: src + "/bayonet/echarts_1?date="+date,//url
            success: function (result) {
                ...
                for (var i = 0; i < result.length; i++) {
                    ...
                    // if (item.department) {
                        ...
                        nameArr.push(item.passportName);
                ...
                option = {
                    ...
                    legend: { //图例组件，颜色和名字
                        ...
                        itemHeight: 10,
                        icon: 'rect',
                        data: nameArr,//['行业一', '行业二', '行业三', '行业四', '行业五'],
                        textStyle: {
                            color: [],
                            fontStyle: 'normal',
                            fontFamily: '微软雅黑',
    ...
    function echarts_2() {
        ...
        $.ajax({
            type: "POST",//方法类型
            //dataType: "text",//预期服务器返回的数据类型
            url: src + "/bayonet/echarts_2?date="+date,//url
            success: function (result) {
                // debugger;
                ...
                for (var i = 0; i <result.length ; i++) {
                    //颜色数组
                    var colorArr=new Array('#f845f1','#ad46f3','#5045f6','#4777f5','#44aff0');
                    var item = result[i];
                    // if (item.department) {
                    data.push({
                        value: item.id,
...
debugger;
    ...
    function echarts_3() {
        ...
        $.ajax({
            type: "POST",//方法类型
            //dataType: "text",//预期服务器返回的数据类型
            url: src + "/bayonet/echarts_3?date="+date,//url
            success: function (result) {
                // debugger;
    ...
    //     debugger;
    //     $.ajax({
    //         url: src +  '/bayonet/getEchartsTest',
    //         type: 'POST',
    ...
    function echarts_4() {
        ...
        $.ajax({
            type: "POST",//方法类型
            //dataType: "text",//预期服务器返回的数据类型
            url: src + "/bayonet/echarts_4?date="+date,//url
            success: function (result) {
                // debugger;
                ...
                option = {
                    ...
                    series: [

                        {
                            name: '排名',
                            type: 'pie',
                            color: ['#af89d6', '#f5c847', '#ff999a', '#0089ff', '#25f3e6', '#f5c847'],
                            radius: [20, 110],
                            center: ['50%', '50%'],
                            roseType: 'area',
                            // data: [
        ...
        //     type: "GET",//方法类型
        //     //dataType: "text",//预期服务器返回的数据类型
        //     url: "$!{rc.contextPath}/bayonet/getEcharts",//url
        //     data: null,
    ...
    function echarts_5() {
        ...
        $.ajax({
            type: "POST",//方法类型
            //dataType: "text",//预期服务器返回的数据类型
            url: src + "/bayonet/echarts_5?date="+date,//url
            ...
            success: function (result) {
                ...
                var xData = function () {
                    // var data =['江虹路-秋溢路口', '滨康路-长河路口', '南环路-时代大道', '网商路-江虹口', '阡陌路-江陵路口'];// nameArr;
                    var data=nameArr;
                    return data;
                }();

                var data = valueArr//[28, 22, 20, 16, 12]
    ...
    function echarts_6() {
        ...
        $.ajax({
            type: "POST",//方法类型
            //dataType: "text",//预期服务器返回的数据类型
            url: src + "/bayonet/echarts_6?date="+date,//url
            success: function (result) {
                // debugger;
                ...
                option = {
                    ...
                    tooltip: {
                        ...
                        formatter: function (params) {
                            var a=params[0]["data"];
                            debugger;
                            return params[0]["data"].gsCode + "<br/>" + '报警次数: ' + params[1]["data"].value + '次';
                        }
                    },
                    xAxis: [{
                        type: 'category',
