(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
    ...
    var urls = [0, 1, 2, 3, 4].map(function(sub) {
        ...
        // return 'http://shangetu' + sub +
        //    '.map.bdimg.com/it/u=x={x};y={y};z={z};v=009;type=sate&fm=46&udt=20150601&scale=0.5';

        return 'http://172.16.97.223/tilefetcher_sate/tiles/{z}/{x}/{y}.png';
    });

    var baidusate = new ol.layer.Tile({
        visible: false,
    ...
    window.baidusate = baidusate;

    var baidugreen = new ol.layer.Tile({
        visible: false,
        source: new ol.source.TileImage({
            ...
            tileUrlFunction: function(tileCoord){
                ...
                //return "http://api2.map.bdimg.com/customimage/tile?x="+x+"&y="+y+"&z="+z+"&udt=20170420&scale=2&ak=8d6c8b8f3749aed6b1aff3aad6f40e37&styles=t%3Abackground%7Ce%3Ag.f%7Cc%3A%2318312c%2Ct%3Ahighway%7Ce%3Aall%7Cc%3A%2345818e%2Ct%3Aarterial%7Ce%3Aall%7Cc%3A%231c525e%2Ct%3Agreen%7Ce%3Aall%7Cc%3A%23385f27%2Ct%3Awater%7Ce%3Aall%7Cc%3A%235590c7%2Ct%3Alocal%7Ce%3Aall%7Cc%3A%2345818e";
                return "http://172.16.97.223/tilefetcher_green/tiles/"+z+"/"+x+"/"+y+".png";
                //return "http://api0.map.bdimg.com/customimage/tile?&x="+x+"&y="+y+"&z="+z+"&udt=20170420&scale=2&ak=E4805d16520de693a3fe707cdc962045&customid=light";
            }
        })
    });

    window.baidugreen = baidugreen;

    var baiduwhite = new ol.layer.Tile({
        visible: false,
        source: new ol.source.TileImage({
            projection: 'baidu',
            tilePixelRatio: 2,
            ...
            tileUrlFunction: function(tileCoord){
                ...
                //return "http://api2.map.bdimg.com/customimage/tile?x="+x+"&y="+y+"&z="+z+"&udt=20170420&scale=2&ak=8d6c8b8f3749aed6b1aff3aad6f40e37&styles=t%3Abackground%7Ce%3Ag.f%7Cc%3A%2318312c%2Ct%3Ahighway%7Ce%3Aall%7Cc%3A%2345818e%2Ct%3Aarterial%7Ce%3Aall%7Cc%3A%231c525e%2Ct%3Agreen%7Ce%3Aall%7Cc%3A%23385f27%2Ct%3Awater%7Ce%3Aall%7Cc%3A%235590c7%2Ct%3Alocal%7Ce%3Aall%7Cc%3A%2345818e";
                return "http://api0.map.bdimg.com/customimage/tile?&x="+x+"&y="+y+"&z="+z+"&udt=20170420&scale=2&ak=E4805d16520de693a3fe707cdc962045&customid=light";
                //return "http://172.16.97.223/tilefetcher_sate_road/tiles/"+z+"/"+x+"/"+y+".png";
            }
        })
    });

    window.baiduwhite = baiduwhite;

    var baidusate1 = new ol.layer.Tile({
        visible: false,
        source: new ol.source.TileImage({
            projection: 'baidu',
            cacheSize: 0,
            ...
            tileUrlFunction: function(tileCoord){
                ...
                //return "http://online2.map.bdimg.com/tile/?qt=tile&x="+x+"&y="+y+"&z="+z+"&styles=sl&udt=20141015";
                //return "http://online2.map.bdimg.com/tile/?qt=tile&x="+x+"&y="+y+"&z="+z+"&styles=sl&udt=20141015";
                return "http://172.16.97.223/tilefetcher_sate_road/tiles/"+z+"/"+x+"/"+y+".png";
    ...
    window.baidusate1 = baidusate1;

    var baidusate2_source =  new ol.source.TileImage({
        projection: 'baidu',
        tilePixelRatio: 2,
        tileGrid: new ol.tilegrid.TileGrid({
            origin: [0, 0],
        ...
        tileUrlFunction: function(tileCoord){
            ...
            return "http://its.map.baidu.com:8002/traffic/TrafficTileService?time="+time+"&x="+x+"&y="+y+"&level="+z;
        }
    });
    window.baidusate2_source = baidusate2_source;
    var baidusate2 = new ol.layer.Tile({
        visible: false,
        source: baidusate2_source
    });

    window.baidusate2 = baidusate2;

    function create_baidusate2(){
        var baidusate2_source =  new ol.source.TileImage({
            projection: 'baidu',
            tilePixelRatio: 2,
            tileGrid: new ol.tilegrid.TileGrid({
    ...
    window.create_baidusate2 = create_baidusate2;

},{"projzh":5}],2:[function(require,module,exports){
    ...
    exports.toGCJ02 = function(input, opt_output, opt_dimension) {
        return forEachPoint(toGCJ02)(input, opt_output, opt_dimension);
    };

    exports.fromGCJ02 = function(input, opt_output, opt_dimension) {
        return forEachPoint(fromGCJ02)(input, opt_output, opt_dimension);
    };

},{"../util":9,"./gcj-02":3}],3:[function(require,module,exports){
    var forEachPoint = require('../util').forEachPoint;
...
},{"./bd-09":2,"./gcj-02":3}],5:[function(require,module,exports){
    ...
    exports.bmerc2ll = function(input, opt_output, opt_dimension) {
        var output = projection.baiduMercator.inverse(input, opt_output, opt_dimension);
        return datum.bd09.toGCJ02(output, output, opt_dimension);
    };

    exports.ll2bmerc = function(input, opt_output, opt_dimension) {
        var output = datum.bd09.fromGCJ02(input, opt_output, opt_dimension);
        return projection.baiduMercator.forward(output, output, opt_dimension);
    };
...
},{"./datum/index":4,"./projection/index":7}],6:[function(require,module,exports){
    var forEachPoint = require('../util').forEachPoint;
...
},{"./baidu-mercator":6,"./spherical-mercator":8}],8:[function(require,module,exports){
    var forEachPoint = require('../util').forEachPoint;
