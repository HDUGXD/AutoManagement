...
,	isMouseOverElem: function (evt, el) {
	 ...
	 *
	 * @ticc $.layout.msg("My message");				// log text
	 * @ticc $.layout.msg("My message", true);		// alert text
	 * @ticc $.layout.msg({ foo: "bar" }, "Title");	// log hash-data, with custom title
	 * @ticc $.layout.msg({ foo: "bar" }, true, "Title", { sort: false }); -OR-
	 * @ticc $.layout.msg({ foo: "bar" }, "Title", { sort: false, display: true }); // alert hash-data
	 *
