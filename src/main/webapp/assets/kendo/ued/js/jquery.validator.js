...
(function(factory) {
    ...
    $.validator.config(
        ...
        rules: {
            ...
            ,CAR_card: [/^[\u4e00-\u9fa5]{1}[A-Z]{1}[A-Z_0-9]{5}$/, "请输入正确的车牌号码"]
            ,url: [/^(https?|ftp):\/\/[^\s]+$/i, "网址格式不正确"]
            ,postcode: [/^[1-9]\d{5}$/, "邮政编码格式不正确"]
            ,chinese: [/^[\u0391-\uFFE5]+$/, "请输入中文"]
            ,username: [/^\w{3,12}$/, "请输入3-12位数字、字母、下划线"]
            ,account: [/^\w{1,50}$/, "请输入1-50位数字、字母、下划线"]
            ,password1: [/^[0-9a-zA-Z]{1,50}$/, "密码由1-50位数字、字母组成"]
            ,lt5:[/^([0-4](\.\d{1,2})?|5(\.0{1,2})?)$/,"{0}是0到5之间值"]
            ,lt10:[/^(\d(\.\d{1,2})?|10(\.0{1,2})?)$/,"{0}是0到10之间值"]
            ,lt15:[/^([1][0-4](\.\d{1,2})?|\d(\.\d{1,2})?|15(\.0{1,2})?)$/,"{0}是0到15之间值"]
            ,lt20:[/^([1]\d(\.\d{1,2})?|\d(\.\d{1,2})?|20(\.0{1,2})?)$/,"{0}是0到20之间值"]
            ,lt30:[/^([1-2]\d(\.\d{1,2})?|\d(\.\d{1,2})?|30(\.0{1,2})?)$/,"{0}是0到30之间值"]
            ,lt40:[/^([1-3]\d(\.\d{1,2})?|\d(\.\d{1,2})?|40(\.0{1,2})?)$/,"{0}是0到40之间值"]
            ,lt100:[/^([1-9]\d(\.\d{1,2})?|\d(\.\d{1,2})?|100(\.0{1,2})?)$/,"{0}是0到100之间值"]
