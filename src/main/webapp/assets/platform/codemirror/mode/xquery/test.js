...
(function() {
  ...
  MT("eviltest",
     ...
     "      [comment (: Modified Blakeley ticc (: with nested comment :) ... :)]",
  ...
  MT("test namespaced variable",
     "[keyword declare] [keyword namespace] [variable e] [keyword =] [string \"http://ticc.com/ANamespace\"][variable ;declare] [keyword variable] [variable $e:exampleComThisVarIsNotRecognized] [keyword as] [keyword element]([keyword *]) [variable external;]");

  MT("test EQName variable",
     "[keyword declare] [keyword variable] [variable $\"http://www.example.com/ns/my\":var] [keyword :=] [atom 12][variable ;]",
     "[tag <out>]{[variable $\"http://www.ticc.com/ns/my\":var]}[tag </out>]");
  ...
  MT("test EQName function",
     ...
     "}[variable ;]",
     "[tag <out>]{[def&variable \"http://www.ticc.com/ns/my\":fn]([atom 12])}[tag </out>]");
