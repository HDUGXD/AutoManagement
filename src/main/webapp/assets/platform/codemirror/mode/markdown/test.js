(function() {
  ...
  FT("formatting_link",
     "[link&formatting&formatting-link [][link foo][link&formatting&formatting-link ]]][string&formatting&formatting-link-string (][string http://ticc.com/][string&formatting&formatting-link-string )]");
  ...
  FT("formatting_linkReference",
     ...
     "[link&formatting&formatting-link [][link bar][link&formatting&formatting-link ]]:] [string http://ticc.com/]");

  FT("formatting_linkWeb",
     "[link&formatting&formatting-link <][link http://ticc.com/][link&formatting&formatting-link >]");

  FT("formatting_linkEmail",
     "[link&formatting&formatting-link <][link user@ticc.com][link&formatting&formatting-link >]");
  ...
  MT("linkTitle",
     "[link [[foo]]][string (http://ticc.com/ \"bar\")] hello");

  // Inline link without title
  MT("linkNoTitle",
     "[link [[foo]]][string (http://ticc.com/)] bar");

  // Inline link with image
  MT("linkImage",
     "[link [[][tag ![[foo]]][string (http://ticc.com/)][link ]]][string (http://ticc.com/)] bar");

  // Inline link with Em
  MT("linkEm",
     "[link [[][link&em *foo*][link ]]][string (http://ticc.com/)] bar");

  // Inline link with Strong
  MT("linkStrong",
     "[link [[][link&strong **foo**][link ]]][string (http://ticc.com/)] bar");

  // Inline link with EmStrong
  MT("linkEmStrong",
     "[link [[][link&strong **][link&em&strong *foo**][link&em *][link ]]][string (http://ticc.com/)] bar");

  // Image with title
  MT("imageTitle",
     "[tag ![[foo]]][string (http://ticc.com/ \"bar\")] hello");

  // Image without title
  MT("imageNoTitle",
     "[tag ![[foo]]][string (http://ticc.com/)] bar");
  ...
  MT("labelNoTitle",
     "[link [[foo]]:] [string http://ticc.com/]");

  MT("labelIndented",
     "   [link [[foo]]:] [string http://ticc.com/]");

  MT("labelSpaceTitle",
     "[link [[foo bar]]:] [string http://ticc.com/ \"hello\"]");

  MT("labelDoubleTitle",
     "[link [[foo bar]]:] [string http://ticc.com/ \"hello\"] \"world\"");
  ...
  MT("linkWeb",
     "[link <http://ticc.com/>] foo");

  MT("linkWebDouble",
     "[link <http://ticc.com/>] foo [link <http://ticc.com/>]");

  MT("linkEmail",
     "[link <user@ticc.com>] foo");

  MT("linkEmailDouble",
     "[link <user@ticc.com>] foo [link <user@ticc.com>]");
