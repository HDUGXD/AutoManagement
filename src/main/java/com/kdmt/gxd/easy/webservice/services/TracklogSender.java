...
public interface TracklogSender {
    public String initTrans(@WebParam(name = "agencyId") String agencyId, @WebParam(name = "agencyKey") String agencyKey) throws java.rmi.RemoteException;
    public String closeTrans(@WebParam(name = "agencyId") String agencyId, @WebParam(name = "agencyKey") String agencyKey) throws java.rmi.RemoteException;
